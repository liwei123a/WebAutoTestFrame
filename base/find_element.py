...
class FindElement(object):
    def __init__(self, driver, current_node):
        self.driver = driver
        self.elements = ReadIni(node=current_node)
    ...
    def get_element(self, key):
        ...
        find_element_dict = {
            ...
            "name":lambda value:self.driver.find_elements_by_name(value),
            "classname":lambda value:self.driver.find_elements_by_class_name(value),
